...
(* CORE_GENERATION_INFO="fir,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.756000,HLS_SYN_LAT=45,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=241,HLS_SYN_LUT=225,HLS_VERSION=2018_3}" *)
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((x_ap_vld_in_sig == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        acc_reg_103 <= 32'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_1_reg_201 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((((tmp_1_reg_201 == 1'd0) & (1'b1 == ap_CS_fsm_state3)) | ((tmp_fu_148_p3 == 1'd0) & (tmp_1_fu_156_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        shift_reg_we0 = 1'b1;
    end else begin
        shift_reg_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((x_ap_vld_in_sig == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign acc_1_fu_181_p2 = (tmp_6_reg_225 + acc_reg_103);
...
always @ (*) begin
    ap_block_state1 = ((x_ap_vld_in_sig == 1'b0) | (ap_start == 1'b0));
end
...
assign tmp_4_fu_167_p1 = $unsigned(i_cast_reg_192);

assign tmp_5_fu_171_p1 = $unsigned(i_cast_reg_192);
