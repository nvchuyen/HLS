...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_1_fu_144_p2 );
    sensitive << ( tmp_fu_136_p3 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_3_fu_150_p1 );
    sensitive << ( tmp_4_fu_155_p1 );
    ...
    SC_METHOD(thread_tmp_4_fu_155_p1);
    sensitive << ( i_cast_reg_181 );

    SC_METHOD(thread_tmp_5_fu_159_p1);
    sensitive << ( i_cast_reg_181 );

    SC_METHOD(thread_tmp_6_fu_163_p0);
    sensitive << ( c_q0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_tmp_6_fu_163_p2);
    sensitive << ( data1_reg_116 );
    sensitive << ( tmp_6_fu_163_p0 );
    ...
    sc_trace(mVcdFile, i_cast_reg_181, "i_cast_reg_181");
    ...
    sc_trace(mVcdFile, tmp_4_fu_155_p1, "tmp_4_fu_155_p1");
    sc_trace(mVcdFile, tmp_5_fu_159_p1, "tmp_5_fu_159_p1");
    sc_trace(mVcdFile, grp_fu_125_p0, "grp_fu_125_p0");
    sc_trace(mVcdFile, tmp_6_fu_163_p0, "tmp_6_fu_163_p0");
    sc_trace(mVcdFile, tmp_6_fu_163_p2, "tmp_6_fu_163_p2");
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
        ...
        data1_reg_116 = shift_reg_q0.read();
                ...
                esl_seteq<1,1,1>(tmp_1_fu_144_p2.read(), ap_const_lv1_1))) {
        data1_reg_116 = x.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_reg_104 = i_1_reg_209.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_reg_104 = ap_const_lv5_A;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_1_reg_209 = grp_fu_125_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_cast_reg_181 = i_cast_fu_132_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_190 = tmp_1_fu_144_p2.read();
    }
}

void fir::thread_acc_1_fu_169_p2() {
    acc_1_fu_169_p2 = (!tmp_6_fu_163_p2.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_6_fu_163_p2.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<4>) (tmp_5_fu_159_p1.read());
}
...
void fir::thread_grp_fu_125_p0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        grp_fu_125_p0 = i_reg_104.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        grp_fu_125_p0 = ap_phi_mux_i_phi_fu_108_p4.read();
    } else {
        grp_fu_125_p0 = "XXXXX";
    }
}
...
void fir::thread_i_cast_fu_132_p1() {
    i_cast_fu_132_p1 = esl_sext<32,5>(i_reg_104.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_4_fu_155_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_144_p2.read(), ap_const_lv1_1))) {
        shift_reg_address0 = ap_const_lv4_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_144_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_3_fu_150_p1.read());
    } else {
...
void fir::thread_tmp_1_fu_144_p2() {
    tmp_1_fu_144_p2 = (!i_reg_104.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_104.read() == ap_const_lv5_0);
}

void fir::thread_tmp_3_fu_150_p1() {
    tmp_3_fu_150_p1 = esl_zext<64,5>(grp_fu_125_p2.read());
}

void fir::thread_tmp_4_fu_155_p1() {
    tmp_4_fu_155_p1 = esl_zext<64,32>(i_cast_reg_181.read());
}

void fir::thread_tmp_5_fu_159_p1() {
    tmp_5_fu_159_p1 = esl_zext<64,32>(i_cast_reg_181.read());
}

void fir::thread_tmp_6_fu_163_p0() {
    tmp_6_fu_163_p0 = c_q0.read();
}

void fir::thread_tmp_6_fu_163_p2() {
    tmp_6_fu_163_p2 = (!tmp_6_fu_163_p0.read().is_01() || !data1_reg_116.read().is_01())? sc_lv<32>(): sc_bigint<32>(tmp_6_fu_163_p0.read()) * sc_bigint<32>(data1_reg_116.read());
}

void fir::thread_tmp_fu_136_p3() {
    tmp_fu_136_p3 = i_reg_104.read().range(4, 4);
}
